...
void MX_FDCAN1_Init(void)
{
  ...
  /* USER CODE BEGIN FDCAN1_Init 2 */
    ...
    HAL_FDCAN_ConfigRxFifoOverwrite(&hfdcan1, FDCAN_RX_FIFO1,
                                    FDCAN_RX_FIFO_OVERWRITE);
...
void MX_FDCAN2_Init(void)
{
  ...
  /* USER CODE BEGIN FDCAN2_Init 2 */
    ...
    HAL_FDCAN_ConfigRxFifoOverwrite(&hfdcan2, FDCAN_RX_FIFO0,
                                    FDCAN_RX_FIFO_OVERWRITE);
    HAL_FDCAN_ConfigRxFifoOverwrite(&hfdcan2, FDCAN_RX_FIFO1,
                                    FDCAN_RX_FIFO_OVERWRITE);
...
void MX_FDCAN3_Init(void)
{
  ...
  /* USER CODE BEGIN FDCAN3_Init 2 */
    ...
    fdcan_filter_config.FilterIndex = 1;
    fdcan_filter_config.FilterConfig = FDCAN_FILTER_TO_RXFIFO1;
    fdcan_filter_config.FilterID1 = 0x13;
    fdcan_filter_config.FilterID2 = 0x14;
    fdcan_filter_config.FilterType = FDCAN_FILTER_RANGE;
    ...
    HAL_FDCAN_ConfigRxFifoOverwrite(&hfdcan3, FDCAN_RX_FIFO0,
                                    FDCAN_RX_FIFO_OVERWRITE);
    HAL_FDCAN_ConfigRxFifoOverwrite(&hfdcan3, FDCAN_RX_FIFO1,
                                    FDCAN_RX_FIFO_OVERWRITE);
