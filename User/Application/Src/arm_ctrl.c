...
static uint8_t g_place_target_index = 0;    // 当前选择的放置点索引 (0:底层, 1:中层, 2:顶层) 
...
static const arm_target_point_t g_arm_target_points[5] = {
	...
	{533.142f, 91.5027f, 0.0349f},        // 2: 抓取点位 (CATCH)，下降到抓取高度 (将动态被外部坐标覆盖)
...
static const arm_target_point_t g_arm_place_points[3] = {
	...
	{-250.12f + 175.0f, FIRST_POINT_Z_LOW + 175.0f, -PI},           // 放置点 1 (中层): 水平向后放 (-PI)
	{-250.12f + 175.0f + 30.0f, FIRST_POINT_Z_LOW + 175.0f + 350.0f, -PI},  // 放置点 2 (顶层): Z轴加高 350mm
};
