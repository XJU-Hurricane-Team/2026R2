...
/* ========== I2C3 引脚宏定义（请按实际接线修改） ========== */
#define IIC3_SCL_GPIO_PORT     GPIOD
#define IIC3_SCL_GPIO_ENABLE() __HAL_RCC_GPIOD_CLK_ENABLE()
#define IIC3_SCL_GPIO_PIN      GPIO_PIN_9

#define IIC3_SDA_GPIO_PORT     GPIOD
#define IIC3_SDA_GPIO_ENABLE() __HAL_RCC_GPIOD_CLK_ENABLE()
