...
#define KEY0  HAL_GPIO_ReadPin(GPIOH, KEY0_GPIO_PIN)
#define KEY1  HAL_GPIO_ReadPin(GPIOH, KEY1_GPIO_PIN)
#define KEY2  HAL_GPIO_ReadPin(GPIOH, KEY2_GPIO_PIN)
#define WK_UP HAL_GPIO_ReadPin(GPIOA, WKUP_GPIO_PIN)
